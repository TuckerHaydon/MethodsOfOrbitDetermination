classdef ThirdBodyPerturbingAccelerationGCRFTests < matlab.unittest.TestCase
    methods (Test)
        function TestAgainstSymbollic(testCase)   
            ...
            r_ddot = -mu * ((r_sat - r_moon) / norm(r_sat - r_moon)^3 - -r_moon ./ norm(-r_moon)^3);
            ...
            r_ddot_ = ThirdBodyPerturbingAccelerationGCRF( ...
                r_sat_, ...
                r_moon_, ...
                mu_);
