classdef ThirdBodyPerturbingAccelerationJacobianGCRFTests < matlab.unittest.TestCase
    methods (Test)
        function TestAgainstSymbollic(testCase)   
            ...
            position_jacobian_ = ThirdBodyPerturbingAccelerationJacobianGCRF(r_sat_, r_moon_, mu_);
        ...
        function TestSingleVectorWithFiniteDifference(testCase)   
            ...
            satellite_position_gcrf = [1e2; 1e2; 2e2];
            moon_position_gcrf      = [2e5; 1e5; -3e5];

            dx = 1; % meters
            perturbed_satellite_position_gcrf = [
                satellite_position_gcrf + [dx; 0; 0], ...
                satellite_position_gcrf - [dx; 0; 0], ...
                satellite_position_gcrf + [0; dx; 0], ...
                satellite_position_gcrf - [0; dx; 0], ...
                satellite_position_gcrf + [0; 0; dx], ...
                satellite_position_gcrf - [0; 0; dx]
            ];
